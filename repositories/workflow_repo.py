...
class WorkflowRepository:
    ...
    async def get_by_id(self, workflow_id: str, tenant_id: str) -> Optional[Workflow]:
...
class WorkflowExecutionRepository:
    ...
    async def get_by_id(self, execution_id: str, tenant_id: str) -> Optional[WorkflowExecution]:
        """Get execution by ID"""
