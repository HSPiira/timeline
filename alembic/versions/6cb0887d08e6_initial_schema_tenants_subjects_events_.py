...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.CheckConstraint("status IN ('active', 'suspended', 'archived')", name='tenant_status_check'),
    ...
    op.create_index('ix_subject_tenant_type', 'subject', ['tenant_id', 'subject_type'], unique=False)
    ...
    op.create_index('ix_document_tenant_checksum', 'document', ['tenant_id', 'checksum'], unique=False)
