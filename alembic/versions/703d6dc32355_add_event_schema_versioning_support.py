...
def upgrade() -> None:
    ...
    op.add_column('event', sa.Column('schema_version', sa.Integer(), nullable=False, server_default='1'))
    ...
    op.create_foreign_key('fk_event_schema_created_by_user', 'event_schema', 'user', ['created_by'], ['id'])
