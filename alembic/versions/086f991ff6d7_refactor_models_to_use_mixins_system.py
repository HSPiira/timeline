...
def upgrade() -> None:
    ...
    op.alter_column('email_account', 'created_at',
               existing_type=postgresql.TIMESTAMP(),
               type_=sa.DateTime(timezone=True),
               existing_nullable=False,
               existing_server_default=sa.text('now()'))
    op.alter_column('email_account', 'updated_at',
               existing_type=postgresql.TIMESTAMP(),
               type_=sa.DateTime(timezone=True),
               existing_nullable=False,
               existing_server_default=sa.text('now()'))
    op.drop_constraint(op.f('email_account_tenant_id_fkey'), 'email_account', type_='foreignkey')
    op.create_foreign_key(None, 'email_account', 'tenant', ['tenant_id'], ['id'], ondelete='CASCADE')
    op.drop_index(op.f('ix_event_type_version'), table_name='event')
    op.create_index('ix_event_tenant_type_version', 'event', ['tenant_id', 'event_type', 'schema_version'], unique=False)
    ...
    op.create_index(op.f('ix_event_schema_created_by'), 'event_schema', ['created_by'], unique=False)
    ...
    op.add_column('workflow_execution', sa.Column('updated_at', sa.DateTime(timezone=True), server_default=sa.text('now()'), nullable=False))
...
def downgrade() -> None:
    ...
    op.create_foreign_key(op.f('user_role_assigned_by_fkey'), 'user_role', 'user', ['assigned_by'], ['id'])
    op.alter_column('user_role', 'assigned_at',
               existing_type=postgresql.TIMESTAMP(timezone=True),
               nullable=True,
               existing_server_default=sa.text('now()'))
    ...
    op.create_foreign_key(op.f('subject_tenant_id_fkey'), 'subject', 'tenant', ['tenant_id'], ['id'])
    op.alter_column('subject', 'created_at',
               existing_type=postgresql.TIMESTAMP(timezone=True),
               nullable=True,
               existing_server_default=sa.text('now()'))
    op.add_column('role_permission', sa.Column('created_at', postgresql.TIMESTAMP(timezone=True), server_default=sa.text('now()'), autoincrement=False, nullable=True))
    op.alter_column('role', 'updated_at',
               existing_type=postgresql.TIMESTAMP(timezone=True),
               nullable=True,
               existing_server_default=sa.text('now()'))
    op.alter_column('role', 'created_at',
               ...
               nullable=True,
               existing_server_default=sa.text('now()'))
    op.add_column('permission', sa.Column('created_at', postgresql.TIMESTAMP(timezone=True), server_default=sa.text('now()'), autoincrement=False, nullable=True))
    op.drop_constraint(None, 'event_schema', type_='foreignkey')
    op.create_foreign_key(op.f('fk_event_schema_created_by_user'), 'event_schema', 'user', ['created_by'], ['id'])
    ...
    op.create_index(op.f('ix_event_type_version'), 'event', ['event_type', 'schema_version'], unique=False)
    op.drop_constraint(None, 'email_account', type_='foreignkey')
    op.create_foreign_key(op.f('email_account_tenant_id_fkey'), 'email_account', 'tenant', ['tenant_id'], ['id'])
    op.alter_column('email_account', 'updated_at',
    ...
    op.drop_constraint(None, 'document', type_='foreignkey')
    op.create_foreign_key(op.f('document_tenant_id_fkey'), 'document', 'tenant', ['tenant_id'], ['id'])
