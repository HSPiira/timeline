...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.UniqueConstraint('tenant_id', 'event_type', 'version', name='uq_tenant_event_type_version')
    )
    ...
    op.create_index('ix_event_schema_active', 'event_schema', ['tenant_id', 'event_type', 'is_active'])
