...
class CredentialEncryptor:
    ...
    def _get_encryption_key(self) -> bytes:
        """
        Get encryption key derived from app secret_key.

        Uses SHA-256 to derive a 32-byte key from the secret_key,
        then base64url-encodes it for Fernet compatibility.
        """
        ...
        key_hash = sha256(key_material).digest()
